...
def plot(agents,team_size,generation, trials):
    DEBUG=0
    ...
    lbls={0:"D Rand.",1:"End State Aprx.",2:"Ctrfctl. Aprx.",3:"LERT",4:"$D^\Sigma$",5:"$G^\Sigma$"}
    if DEBUG:
        plt.subplot(1,2,1)
    mint=1e9
...
generation=300
trials=[0]
plot(agents,team_size,generation, trials)